...
public class Filial implements Serializable {
	...
	@IdentificaCampoPesquisa(descricaoCampo = "Codigo", campoConsulta = "fil_codigo")
	@Id
	@Column(name = "fil_codigo")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "filial_seq")
	private Long fil_codigo;

	@IdentificaCampoPesquisa(descricaoCampo = "Descricao", campoConsulta = "fil_descricao", principal = 1)
	...
	private String fil_segurancaemail;

	@Column(length = 100)
	//@Enumerated(EnumType.STRING)
	//private EmailAutenticacao fil_autenticacaoemail;
	private String fil_autenticacaoemail;
	...
	public String getFil_segurancaemail() {
		return fil_segurancaemail;
	}

	public void setFil_segurancaemail(String fil_segurancaemail) {
		this.fil_segurancaemail = fil_segurancaemail;
	}

	public String getFil_autenticacaoemail() {
		return fil_autenticacaoemail;
	}

	public void setFil_autenticacaoemail(String fil_autenticacaoemail) {
