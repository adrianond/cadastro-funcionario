...
public class Bairro implements Serializable {
	...
	@IdentificaCampoPesquisa(descricaoCampo = "Codigo", campoConsulta = "bai_codigo")
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bairro_seq")
	private Long bai_codigo;

	@IdentificaCampoPesquisa(descricaoCampo = "Descricao", campoConsulta = "bai_descricao", principal = 1)
