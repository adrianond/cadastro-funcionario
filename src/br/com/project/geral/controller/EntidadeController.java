...
public class EntidadeController extends ImplementacaoCrud<Entidade> implements
	...
	public void updateUltimoAcessoUser(String name) {
		repositoryEntidade.updateUltimoAcessoUser(name);
	}
	...
	public List<Entidade> cpfCadastrado(String cpf) throws Exception {
		return super.findListByQueryDinamica("FOM Entidade where cpf = '" + cpf + "'");
	}
