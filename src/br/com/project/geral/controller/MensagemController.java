...
public class MensagemController extends ImplementacaoCrud<Mensagem> implements InterfaceCrud<Mensagem> {
	...
	public Mensagem confirmaLeituraMsg(Mensagem objetoSelecionado) throws Exception {
		if (objetoSelecionado.getMen_exigirresposta()){
			...
			builderMsg.append("*******************Confirma��o de leitura*******************\n");
		 ...
		 //desmarca para n�o repetir o envio de msg lida caso o usuario leia novamente a msg
	...
	*/
	...
	@Override
	public Mensagem merge(Mensagem msg) throws Exception {
		return super.merge(msg);
	}
}
