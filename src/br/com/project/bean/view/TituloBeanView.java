...
public class TituloBeanView extends BeanManagedViewAbstract {
	...
	private void validarEntidadeBaixa() {
		if (objetoSelecionado.getEntCodigoBaixa() == null
				|| (objetoSelecionado.getEntCodigoBaixa() != null && objetoSelecionado
						.getEntCodigoBaixa().getEnt_codigo() == null)
				|| (objetoSelecionado.getEntCodigoBaixa().getEnt_codigo() != null && objetoSelecionado
						.getEntCodigoBaixa().getEnt_codigo() < 0)) {
			objetoSelecionado.setEntCodigoBaixa(null);
		}
	}

	@Override
	public void excluir() throws Exception {
			if (objetoSelecionado.getTituloCodigo() != null && objetoSelecionado.getTituloCodigo() > 0) {
	...
	public String editar() throws Exception {
		...
		if (objetoSelecionado.getTituloBaixado() != null && objetoSelecionado.getTituloBaixado()){
			return urlBaixado;
		}
	...
	public String baixa() throws Exception {
		objetoSelecionado.setEntCodigoBaixa(contextoBean.getEntidadeLogada());
		objetoSelecionado.setTituloDataBaixa(new Date());
		return urlBaixar;
	}
	...
	public String condicaoAndParaPesquisa() {
		if (getTituloSituacaoTemp() != null
			...
			return consultarInativosBoolean() ? " and entity.tituloBaixado = false " : "and entity.entCodigo.ent_inativo is false and entity.tituloBaixado = false ";
		}
		return consultarInativosBoolean() ? "" : "and entity.entCodigo.ent_inativo is false ";
	}
	...
	public String efetuarBaixa() throws Exception {
			objetoSelecionado.setEntCodigoBaixa(contextoBean
					.getEntidadeLogada());
			objetoSelecionado.setTituloDataBaixa(new Date());
			objetoSelecionado.setTituloBaixado(Boolean.TRUE);
