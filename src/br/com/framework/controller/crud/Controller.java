...
public class Controller extends ImplementacaoCrud<Object> {
	...
	/*
	 * @Override public List findListByProperty(Class entidade, Object atributo,
	 * Object valor) throws Exception { return super.findListByProperty(entidade,
	 * atributo, valor); }
	 * 
	 * @Override public List findListByListDeIds(Class entidade, List cods) throws
	 * Exception { return super.findListByListDeIds(entidade, cods); }
	 * 
	 * 
	 * @Override public List finList(Class entidade) throws Exception {
	 * 
	 * return super.finList(entidade); }
	 * 
	 * @Override public Class getClass(Class entidade) throws Exception { return
	 * super.getClass(entidade); }
	 */
